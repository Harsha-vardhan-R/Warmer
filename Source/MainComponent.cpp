...
MainComponent::MainComponent() {
    ...
    this->masterComponent = std::make_unique<MasterComponent>(menuBarComponent.get()->getHeight(), 100);
    ...
    this->midiPianoComponent = std::make_unique<MIDIPianoComponent>( getHeight()-75,
                                                                     75
    );
